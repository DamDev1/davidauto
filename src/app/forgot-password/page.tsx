...
import { Mail, ArrowRight, Car, Loader2, ArrowLeft } from "lucide-react";
        ...
        >
          <div className="bg-card/80 backdrop-blur-xl border border-white/5 rounded-3xl p-8 sm:p-10 shadow-2xl overflow-hidden relative">
            ...
            >
              <Link
                href="/login"
                className="inline-flex items-center font-medium text-white hover:text-primary transition-colors hover:underline underline-offset-4"
              >
